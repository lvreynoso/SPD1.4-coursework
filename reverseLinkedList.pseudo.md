...
Second, if necessary, we create a second temp variable to keep track of next nodes.
For each node in the linked list,
  If we need to keep track of the next node to keep iterating through the linked list, set this node's next to a (second) temp variable.
